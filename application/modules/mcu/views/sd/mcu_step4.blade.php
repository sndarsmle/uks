                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea required name="ket_kacamata" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$matatelinga->ket_kacamata}}</textarea>
                                                    <!-- <br /> --><br />
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea name="ket_telinga" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$matatelinga->ket_telinga}}</textarea>
                                                    <br /><br />
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea name="ket_kot_telinga" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$matatelinga->ket_kot_telinga}}</textarea>
                                                    <br /><br />
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <textarea name="ket_inf_telinga" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$matatelinga->ket_inf_telinga}}</textarea>
                                                    <br /><br />
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <br>
                                                    <textarea name="ket_tajam_pendengaran" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$matatelinga->ket_tajam_pendengaran}}</textarea>
                                                    <br /><br />
                                                </div>
                                            </div>
                                            <dir class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea name="ket_masalah_lain_pendengaran" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$matatelinga->ket_masalah_lain_pendengaran}}</textarea>
                                                    <br /><br />
                                                </div>
                                                <div class="col-lg-6"></div>
                                            </dir>
