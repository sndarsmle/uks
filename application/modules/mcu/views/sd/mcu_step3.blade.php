...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Medical Check Up - SD Teladan</h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <br /><textarea required name="ket_masalah_lain_rongga_mulut" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$mulut->ket_masalah_lain_rongga_mulut}}</textarea>
                                                    <br /><br />
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    </label><br><textarea required name="ket_caries" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$mulut->ket_masalah_lain_gigi_gusi}}</textarea>
                                                    <br /><br />
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea required name="ket_masalah_lain_gigi_gusi" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$mulut->ket_masalah_lain_gigi_gusi}}</textarea>
                                                    <br /><br />
                                                </div>
