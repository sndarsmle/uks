                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       class="form-control"
                                       value="{{ formatJenjang($siswa->siswa_jenjang) . ' - ' . $siswa->siswa_kelas }}"
                                       readonly>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text"
                                       class="form-control"
                                       value="{{ $siswa->siswa_umurT . ' Tahun ' . $siswa->siswa_umurB . ' Bulan' }}"
                                       readonly>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">
                        {{ $mcu->periode_name != "SCR" ? "Medical Check Up" : "Screening" }} - SD Teladan
                    </h4>
                    <form action="" method="post">
                        <div class="row">
                            <div class="col-md-4 col-lg-3">
                                <div class="nav flex-column nav-pills">
                                    <a href="#v-pills-home" class="nav-link active show">
                                        Status Gizi
                                    </a>
                                    @if(isset($role) && ($role == 3 || $role == 0))
                                    <a href="{{ base_url('mcu/SD/step2/' . $mcu->mcu_id) }}"
                                       class="nav-link">
                                        Pemeriksaan Umum
                                    </a>
                                    <a href="{{ base_url('mcu/SD/step3/' . $mcu->mcu_id) }}"
                                       class="nav-link">
                                        Gigi dan Mulut
                                    </a>
                                    <a href="{{ base_url('mcu/SD/step4/' . $mcu->mcu_id) }}"
                                       class="nav-link">
                                        Penglihatan dan Pendengaran
                                    </a>
                                    <a href="{{ base_url('mcu/SD/step5/' . $mcu->mcu_id) }}"
                                       class="nav-link">
                                        Lainnya
                                    </a>
                                        @if($role == 3)
                                            <a href="{{ base_url('mcu/SD/evaluasi/' . $mcu->mcu_id )}}"
                                               class="nav-link">
                                                Evaluasi
                                            </a>
                                        @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       class="form-control"
                                                       value="{{ $mcu->mcu_ageY . ' Tahun ' . $mcu->mcu_ageM . ' Bulan' }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
