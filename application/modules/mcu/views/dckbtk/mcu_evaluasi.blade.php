                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-3">
                            <div class="nav flex-column nav-pills">
                                ...
                                <a href="{{base_url('mcu/dckbtk/evaluasi/'.$mcu->mcu_id)}}" class="nav-link">Lainnya</a>
                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="tab-content" style="color: black">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">8. BB/U </div>
                                            <div class="col-lg-6">:&nbsp&nbsp<?php if ($mcu->bbperu == "1") {
                                                                                    echo "Normal";
                                                                                } else  if ($mcu->bbperu == "2") {
                                                                                    echo "Gizi Kurang";
                                                                                } else {
                                                                                    echo "Gizi Berlebih";
                                                                                }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">2. Hidung</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">3. Rongga Mulut</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">4. Jantung</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">5. Paru</div>
                                            <div class="col-lg-6">:&nbsp&nbsp<?php if ($mcu->paru == '1') {
                                                                                    echo "Normal";
                                                                                } else {
                                                                                    echo "Ada Kelainan";
                                                                                }
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">Keterangan</div>
                                            <div class="col-lg-6">:&nbsp&nbsp{{$mcu->ket_paru}}</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">6. Neurologi</div>
                                            <div class="col-lg-6">:&nbsp&nbsp{{$mcu->neurologi}}</div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">7. Rambut</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">8. Kulit</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">Keterangan</div>
                                            <div class="col-lg-6">:&nbsp&nbsp{{$mcu->ket_telinga}}</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">Keterangan</div>
                                            <div class="col-lg-6">:&nbsp&nbsp{{$mcu->ket_kot_telinga}}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">Keterangan</div>
                                            <div class="col-lg-6">:&nbsp&nbsp{{$mcu->ket_inf_telinga}}</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row">
