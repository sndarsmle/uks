                                ...
                                <div class="tab-content">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <br>
                                                <textarea name="ket_mata" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_mata}}</textarea>
                                                <br /><br />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <br>
                                                <textarea name="ket_hidung" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_hidung}}</textarea>
                                                <!--  <br /> --><br />
                                            </div>
                                        ...
                                        <div class="form-group box-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea name="ket_rongga_mulut" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_rongga_mulut}}</textarea>
                                                    <br /><br />
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea name="ket_jantung" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_jantung}}</textarea>
                                                    <br /><br />
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea name="ket_paru" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_paru}}</textarea>
                                                    <br /><br />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <br />
                                                    <textarea name="neurologi" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->neurologi}}</textarea>
                                                    <br />
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea name="ket_rambut" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_rambut}}</textarea>
                                                    <br /><br />
                                                </div>
                                                <div class="col-md-6">
                                                    <label>
                                                    ...
                                                    <textarea name="ket_kulit" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_kulit}}</textarea>
                                                    <br /><br />
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="ket_kuku" placeholder="Penjelasan. isi dengan tanda '-' jika tidak ada. " class="form-control" cols="10" rows="3">{{$umum->ket_kuku}}</textarea>
                                            <br /><br />
                                        </div>
                                        <div class="col-md-6">
