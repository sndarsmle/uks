            ...
            <div class="card">
                <div class="card-body">
                    <div class="row float-right">
                        <div class="col-12">
                            <button class="btn btn-primary waves-effect waves-light export_rmcu_guru_button">Export ke Excel</button>
                        </div>
                    </div>
                    <h4 class="card-title">Detail Laporan MCU / Screening</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($data->mcu_isfinish or $data->dokter_id)
                                            <a href="{{base_url('cetakdoc/precetakmcu/'.$data->mcu_id)}}" class="btn btn-success" style="color:white">Lihat </a>
                                        @else
...
<script src="{{base_url('assets/js/report/rmcu_guru.js')}}"></script>
<script >
