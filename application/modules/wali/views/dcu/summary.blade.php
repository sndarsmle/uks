...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Laporan Dental Checkup</h4>
                    <div class="table-responsive" >
                        <table class="table table-bordered table-hover" id="table">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Periode DCU</th>
                            ...
                            @foreach($periode as $i => $jad)
                                <tr>
                                    ...
                                    <td>{{$jad->jumlah}}</td>                                 
                                    <td>
                                        <a href="{{base_url('wali/detailDCU/'.$jad->periode_id)}}" class="btn btn-success" style="color:white">Lihat </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
