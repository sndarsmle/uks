...
<div class="box">
	<div id="cetak" style="color: black; font-size: 12px;">
		<div>
			<img src="{{ base_url('assets/images/headersmp.jpg') }}" alt="" width="100%">
			<br><br>
		</div>
		<div style="margin-left: 80px;margin-right:80px ">
			...
			<center>
				<p>
					<b>
						<h4>HASIL PEMERIKSAAN @if($mcu->periode_name == "MCU") MEDICAL CHECK UP @else GENERAL SCREENING @endif</h4>
					</b>
				</p>
			</center>
			...
			<div>
				...
				<table style="width:100%;padding: 5px;border-width: 1px;">
					...
					<tr>
						...
						<td class="bukankiri">{{ isset($gizi->stun) ? ($gizi->stun == '2' ? 'Ya' : 'Tidak') : '' }}</td>
						<td class="bukankiri"></td>
					...
					<tr>
						<td class="kiri">Tampak Anemis</td>
						<td class="bukankiri">{{ isset($gizi->anemia) ? ($gizi->anemia == '2' ? 'Ya' : 'Tidak') : '' }}</td>
						<td class="bukankiri"></td>
						<td class="bukankiri">Tidak</td>
						<td class="bukankiri"></td>
					</tr>
				...
				<table class="d-flex justify-content-end align-items-center text-center">
					<tr>
						<td class="px-3">Sleman, {{ formatTanggal($mcu->mcu_date) }} </td>
					</tr>
					<tr>
					...
					<tr>
						<td class="px-3">{{ $dokter->dokter_fullname ?? "Dokter tidak ditemukan" }}</td>
					</tr>
				</table>
			</div>
		</div>
