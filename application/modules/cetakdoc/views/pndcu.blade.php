...
<div class="container-fluid">
    ...
    <div style="text-align: center;">
        <h2>
            <span style="color: green; "> Data Dental Check Up Siswa</span>
        </h2>
    </div>
    <br/>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ base_url('cetakdoc/pddcu') }}" method='POST'>
...
<script >
    $(document).ready(function() {
        ...
        $("#pilihJenjang").change(function() {
            let level = document.getElementById("pilihJenjang").value;
            $("#searchSiswa").select2({
                theme: "bootstrap4",
                ajax: { 
                    url: '{{ base_url('api/siswa/liveSearch2?key=') }}' + level,
                    type: "post",
                    dataType: 'json',
                    delay: 250,
