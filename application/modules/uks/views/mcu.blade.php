...
<div class="container-fluid">
    ...
    <center><h2><font color="green"> Medical Check Up Siswa</font></h2></center>
    
     

    </br>
    <div class="content">
    <form action="inputmcu" method="post" oninput="pimt.value = parseFloat((+bb.value))/ (parseFloat((+tb.value*0.01))*parseFloat((+tb.value*0.01)));"  id="regForm">
      <div style="padding-top: 0px;">
                        ...
                        <div class="row">
                            ...
                            ?>
                                <div class="form-group">
                                    ...
                                    <label>Kelas</label>
                                    <input type="text" class="form-control" name="kelas" placeholder="Kelas" id="kelas" value="{{$content->kelas}}"readonly><br />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="jadwal_screening" class="form-control" id="peri_mcu" onchange="umur_js()" >
                                        <option value="">-Pilih Periode MCU-</option>
                                    ...
                                    <label>Usia saat Medical Check up</label>
             ...
             <div class="form-group box-body">
              ...
              <div class="row" id="notsmp2">
                ...
                <h4><label><font color="green"><b> Kategori Status Gizi</b></font></label></h4>
                  ...
                  <div class="row">
                  <?php
                      if($content->jenjang == "33" || $content->jenjang == "44"){
                  ?>
                    <div class="col-md-6">
                        <label>8. TB/U (Stuning)</label><br />
                        <label>
                  ...
                  <?php
                      }else if($content->jenjang == "22" || $content->jenjang == "11"){
                  ?>
                    <div class="col-md-6">
                        <label>8. BB/U</label><br />
                        <label>
        ...
        <div class="box-body">
            ...
            <h4><label><font color="green"><b> Kepala</b></font></label></h4>
                ...
                <label>
                  <input type="radio" name="mulut" class="minimal" value="1" checked required > Normal &nbsp&nbsp&nbsp&nbsp&nbsp
                  <input type="radio" name="mulut" class="minimal" value="2" required > Gangguan/Kelainan &nbsp&nbsp&nbsp&nbsp&nbsp
                </label> <br>
                ...
                <br /><br />
                    ...
                    <div class="col-md-6">                                
                      <label>
                        <?php if ($content->jenjang=="44") {
                          echo "Kulit Bercak, Keputihan,kemerahan/kehitaman";
                        }
                        else{
                          echo "Kulit";
                ...
                <label>
                  <input type="radio" name="kulit" class="minimal" value="1" checked required > <?php if ($content->jenjang=="44") {
                    echo "Tidak ada/ Sehat";
                  }
                  else{echo "Sehat/Bersih";} ?>   &nbsp&nbsp&nbsp&nbsp&nbsp
                  <input type="radio" name="kulit" class="minimal" value="2" required ><?php if ($content->jenjang=="44") {
                    echo "Ada/ Tidak Sehat";
                  }
                  else{echo "Tidak Sehat/Kotor";} ?>   &nbsp&nbsp&nbsp&nbsp&nbsp
                </label>
                <br>
             ...
             <div class="form-group box-body">
              <div class="row">
                <div class="col-md-6">
                    ...
                    <br />
                      <label>
                      <input type="radio" name="kulit_sisik" class="minimal" value="1" checked required > Tidak &nbsp&nbsp&nbsp&nbsp&nbsp
                      <input type="radio" name="kulit_sisik" class="minimal" value="2" required > Ya &nbsp&nbsp&nbsp&nbsp&nbsp
                      </label><br /><br /> 
                </div>
                <div class="col-md-6">
                 ...
                 <br />
                      <label>
                      <input type="radio" name="kulit_memar" class="minimal" value="1" checked required > Tidak &nbsp&nbsp&nbsp&nbsp&nbsp
                      <input type="radio" name="kulit_memar" class="minimal" value="2" required > Ya &nbsp&nbsp&nbsp&nbsp&nbsp
                      </label><br /><br />  
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                    ...
                    <br />
                      <label>
                      <input type="radio" name="kulit_sayatan" class="minimal" value="1" checked required > Tidak &nbsp&nbsp&nbsp&nbsp&nbsp
                      <input type="radio" name="kulit_sayatan" class="minimal" value="2" required > Ya &nbsp&nbsp&nbsp&nbsp&nbsp
                      </label><br /><br />
                </div>
                <div class="col-md-6">
                 ...
                 <br />
                      <label>
                      <input type="radio" name="kulit_koreng" class="minimal" value="1" checked required > Tidak &nbsp&nbsp&nbsp&nbsp&nbsp
                      <input type="radio" name="kulit_koreng" class="minimal" value="2" required > Ya &nbsp&nbsp&nbsp&nbsp&nbsp
                      </label><br /><br /> 
                </div>
              </div>
              <div class="row">
                      ...
                      <label>
                           <input type="radio" name="kulit_koreng_sukar" class="minimal" value="1" required checked="" > Tidak &nbsp&nbsp&nbsp&nbsp&nbsp
                           <input type="radio" name="kulit_koreng_sukar" class="minimal" value="2" required > Ya &nbsp&nbsp&nbsp&nbsp&nbsp
                     ...
                     <label>
                      ...
                      <label>
                      <input type="radio" name="kulit_suntik" class="minimal" value="1" checked required > Tidak &nbsp&nbsp&nbsp&nbsp&nbsp
                      <input type="radio" name="kulit_suntik" class="minimal" value="2" required > Ya &nbsp&nbsp&nbsp&nbsp&nbsp
                      </label><br /><br />  
                      </div>
      ...
      <div class="tab">
        ...
        <h4><label><font color="green"><b> Kesehatan Rongga Mulut</b></font></label></h4>
            ...
            <div class="box-header with-border">
                <h3 class="box-title"><b>D. Pemeriksaan Kesehatan Penglihatan dan Pendengaran</b></h3>
            </div> 
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Tajam Penglihatan</label><br />
                            <label>
                    ...
                    <div class="row">
                        ...
                        <!-------
                        <div class="col-md-6" id="onlysmp3">
                            <label>Buta Warna</label><br />
                            <label>
                                <input type="radio" name="buta_warna" class="minimal" value="1" checked required > Tidak &nbsp&nbsp&nbsp&nbsp&nbsp
                                <input type="radio" name="buta_warna" class="minimal" value="2" required > Ya &nbsp&nbsp&nbsp&nbsp&nbsp
                            </label>
                        </div>---->
                        <div class="col-md-6">
                            <label>Masalah Lainnya</label><br />
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                        ...
                        <textarea class="form-control" rows="3" cols="10" placeholder="Penjelasan..." name="followup"></textarea>
              ...
              <div class="form-group">
                <label>Nama Dokter Periksa</label>
                 <select name="dokter" class="form-control" >
                    <option value="dr. Yuliani">dr. Yuliani
                    </option>
                    <option value="dr. Yuliana">dr. Yuliana
                    </option>
                    <option value="dr. Fitri Islamiyah SR">dr. Fitri Islamiyah SR
                    </option>
                    <option value="drg. Despita">drg. Despita
                    </option>
                    <option value="drg. Nur Uswatun">drg. Nur Uswatun
                    </option>
                    </select><br />
