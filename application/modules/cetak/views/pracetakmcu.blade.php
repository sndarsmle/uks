...
<table style="border-style: solid; border-spacing: 0px;border-width: 1px">
  ...
  <tr>
    ...
    ?>
    <td class="identitas">{{$jenjang}} - {{$basicsiswa[0]->kelas_tingkat;}}{{$basicsiswa[0]->kelas_rombel;}}</td>
    <td class="identitas">Tanggal MCU</td>
    <td class=""><?php echo $tanggal_mcu;?></td>
  </tr>
  <tr>
    <td class="identitas"> Umur   </td>
    <td class="identitas" >{{$content[0]->usia_tahun}} Tahun {{$content[0]->usia_bulan}} Bulan</td>
  ...
  <div>
    ...
    <table style="width:100%;padding: 5px;border-width: 1px;" >
      ...
      <tr>
        ...
        <td class="bukankiri"> {{$content[0]->berat_badan}}</td>
      ...
      <tr>
        ...
        <td class="bukankiri"> {{$content[0]->tinggi_badan}}</td>
      ...
      <tr>
        ...
        <td class="bukankiri"> {{$content[0]->lingkar_kepala}}</td>
        <td class="bukankiri">cm</td>
        <td class="bukankiri"></td>
        <td class="bukankiri"></td>
      </tr>
      ...
      <tr>
        ...
        <td class="bukankiri"> {{$content[0]->lingkar_lengan_atas}}</td>
        <td class="bukankiri">cm</td>
        <td class="bukankiri"></td>
        <td class="bukankiri"></td>
      </tr>
      ...
      <tr>
        ...
        <td class="bukankiri"> {{$content[0]->lingkar_perut}}</td>
        <td class="bukankiri">cm</td>
        <td class="bukankiri"></td>
        <td class="bukankiri"></td>
      </tr>
      ...
      <tr>
        ...
        <td class="bukankiri"> <?php if ($content[0]->stuning=="2") {
          echo "Ya";
        } else{echo "Tidak";} ?> </td>
        <td class="bukankiri"></td>
      ...
      <tr>
        ...
        <td class="bukankiri"><?php if ($content[0]->celah_bibir=="2") {
          echo "Ya";
        } else{echo "Tidak";} ?></td>
        <td class="bukankiri"></td>
        <td class="bukankiri">Tidak</td>
        <td class="bukankiri">{{$content[0]->ket_celah_bibir}}</td>
      </tr>

      <tr>
        <td class="kiri">Luka Pada Sudut Mulut</td>
        <td class="bukankiri"> <?php if ($content[0]->luka_sudut_mulut=="2") {
          echo "Ya";
        } else{echo "Tidak";} ?></td>
        <td class="bukankiri"></td>
        <td class="bukankiri">Tidak</td>
      ...
      <tr>
        ...
        <td class="bukankiri"> <?php if ($content[0]->lidah_kotor=="2") {
          echo "Ya";
        } else{echo "Tidak";} ?></td>
        <td class="bukankiri"></td>
        <td class="bukankiri">Tidak</td>
      ...
      <tr>
        ...
        <td class="bukankiri"><?php if ($content[0]->luka_lainnya=="2") {
          echo "Ya";
        } else{echo "Tidak";} ?></td>
        <td class="bukankiri"></td>
        <td class="bukankiri">Tidak</td>
        <td class="bukankiri">{{$content[0]->ket_luka_lainnya}}</td>
      </tr>
      ...
      <tr>
        ...
        <td class="bukankiri"></td>
        <td class="bukankiri">Tidak</td>
        <td class="bukankiri">{{$content[0]->ket_caries}}</td>
      </tr>
      ...
      <tr>
        ...
        <td class="bukankiri"><?php if ($content[0]->tajam_penglihatan=="1") {
          echo "Normal";
        } elseif($content[0]->tajam_penglihatan=="2"){echo "Low Vission";}
        elseif ($content[0]->tajam_penglihatan=="3") {
           echo "Kebutaan";
         }
         elseif ($content[0]->tajam_penglihatan=="4") {
