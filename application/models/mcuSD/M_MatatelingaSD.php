...
class M_MatatelingaSD extends CI_model
{
    private $table = "mcu_matatelingasd";
    ...
    function createRow($Data){
        ...
        $result = $this->db->insert($this->table, $matatelingaSD);
        return $result;
    }
    ...
    function updateRow($Data){
        ...
        $result = $this->db->update($this->table, $matatelingaSD);
        return $result;
    }
}